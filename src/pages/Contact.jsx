              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:pruthvi@weddingsbypru.com" className="text-gray-600 hover:text-gray-800">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+91 9538939944" className="text-gray-600 hover:text-gray-800">
                      +91 95389 39944
                    </a>
                  </div>
                </div>
